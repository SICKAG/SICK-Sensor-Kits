...
Welcome to the **Vision Starter Kit** documentation.

The Vision Starter Kit helps you get started with image-based sensor applications and AI-supported vision examples. It includes an industrial vision sensor, sample code, configurations and documentation for educational and demonstration purposes.
...
- High-resolution image capture
- AI-supported object detection and classification
- Easy-to-use configuration with SICK Nova
- Example objects and sample projects for a quick start

## What can you do with it?

With the Vision Starter Kit, you can explore typical vision applications such as:

- object detection
- classification tasks
- sorting examples
- quality control scenarios
- AI-based image processing demos

## What is included?

The Vision Starter Kit contains the following components:
...
??? info "Show component overview image"
    ![Quickstart Vision](../images/Quickstart Vision.png)

## Recommended next step

Start with the setup guide to connect the hardware and run your first demo.


[Getting started](../vision/vision_getting_started.md){.md-button .button-small}
