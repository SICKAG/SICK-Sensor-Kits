...
Es handelt sich dabei nicht um fertige Projekte, sondern um wiederverwendbare Bausteine zum Auslesen von Geräteinformationen, zum Anfordern von Scandaten und zum Empfangen von Feldauswertungsergebnissen.
...
## Beispiel 4: Ergebnis der Feldauswertung auslesen
...
??? question "Das Skript bricht beim kontinuierlichen Einlesen von Scandaten ab. Was kann ich verbessern?"
    ...
    - Vermeiden Sie es, jede vollständige Antwort auszudrucken, wenn die Ausgabe zu umfangreich ist.
