...
![IO-Link-Konnektivitäts-Starterkit](../images\iolink.jpg)
...
<table style="border-collapse: collapse; width: 100%;">
  ...
  <tbody>
    ...
    <tr>
      <td>9</td>
      <td>Grüne und rote LEDs <br>(in den Stecker eingesetzt)</td>
      <td>2</td>
      <td>
        6092050<br>
        6092051
...
![Vision-Kit – Komponenten](../images/Quickstart IO-Link.png)
...
![IO-Link-Konnektivitäts-Starter-Kit](../images/iolink.jpg)
