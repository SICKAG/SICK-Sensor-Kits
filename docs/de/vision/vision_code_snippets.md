...
Stellen Sie sicher, dass das Vision Starter Kit angeschlossen und von Ihrem Computer aus erreichbar ist.
...
!!! warning "Auftragsnummer"
    Der Befehl `set job 2` wählt die Auftragsnummer 2 aus.  
    Ändern Sie diesen Wert, falls in Ihrem jeweiligen Auftrag eine andere Zahl verwendet wird.
