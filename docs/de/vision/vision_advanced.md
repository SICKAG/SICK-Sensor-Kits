...
Sie haben erfahren, wo Sie weitere Produktinformationen finden, wie Sie den SICK AppManager nutzen, wie Firmware- und SICK Nova-Updates installiert werden können und wie sich das Starter-Kit mit Zubehör, externen Systemen und individuellen Bildverarbeitungs-Workflows erweitern lässt.
