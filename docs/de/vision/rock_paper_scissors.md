...
|------------------------|------------------------|
| **SICK Vision Starter Kit**<br>InspectorP61x für die industrielle Bildverarbeitung <br> Die Datenübertragung erfolgt über Ethernet. | **Raspberry Pi 5**<br>Ist ein vollwertiger Computer, an den ein Monitor, eine Tastatur und eine Maus angeschlossen werden können.<br>Empfängt Daten vom Sensor und verarbeitet diese in einem Python-Programm.<br>Steuerung über [SSH](https://www.cloudflare.com/de-de/learning/access-management/what-is-ssh/)
...
Drücken Sie die Eingabetaste, um den Befehl zu senden. Wenn wir alles korrekt eingegeben haben, werden wir nun aufgefordert, das Passwort für den Raspberry Pi einzugeben. In diesem Fall handelt es sich um das Passwort, das wir bei der Konfiguration des Betriebssystems gewählt haben. In unserem Beispiel wäre dies „raspberry“. 
...
Wenn wir bis zu diesem Punkt alles richtig gemacht haben, sollte die folgende Ausgabe zu sehen sein.
...
>**Hinweis:**
>Falls Ihre Ausgabe von der hier gezeigten abweicht, sollten Sie die IP-Adresse und die physische Verbindung Ihres Sensors noch einmal überprüfen. 
